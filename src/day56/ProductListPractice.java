...
public class ProductListPractice {
    ...
    public static void main(String[] args) {
        ...
        productList.add(new Product2("Macbook Pro", 2999));
        productList.add(new Product2("Sony TV", 499));
        productList.add(new Product2("Macbook Air", 1299));
        productList.add(new Product2("Iphone X", 999));
        productList.add(new Product2("Iphone XL", 1299));
        productList.add(new Product2("Sumsung 10", 1188));
        productList.add(new Product2("Sumsung Note", 1288));
...
// How does contains method decide whether the list contains the object we are looking for ?
        ...
        Product2 sony = new Product2("Sony TV", 499);
