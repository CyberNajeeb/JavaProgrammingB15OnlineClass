...
*/
        ...
        Developers Vladislav = new Developers("Vladislav", "DevOps", 130000);
        //   Vladislav.getEmployeeInfo();

        Developers Emel = new Developers("Emel", "DevOps",130005);
        Developers Muge = new Developers("Muge", "DevOps",130010);
