...
public class MultiDArraysPractice {
    ...
    public static void main(String[] args) {
     /*   String[][] names = {{"Najeeb", "Arman"}, {"Svetlana", "Daria"}};
        ...
        for (int i = 0; i < numbers.length; i++) {
            //System.out.println("numbers = " + Arrays.toString(numbers[i]));
        ...
        System.out.println("\n========================================");
        int[][] ages = {{16}, {18, 21}, {12, 13, 14, 15, 16, 17}, {19, 20, 21, 22, 23}};
        ...
        for (int i = 0; i < ages.length; i++) {
            for (int j = 0; j < ages[i].length; j++) {
                ...
                System.out.println("Ages = " + ages[i][j]);
            }
        }
*/
                            // CLASS CODE
