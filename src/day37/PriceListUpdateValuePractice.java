...
//        priceList.set(0 , newValue ) ;
        ...
        priceList2.add(9.99);
        priceList2.add(12.99);
        priceList2.add(34.00);
        priceList2.add(3.95);
        priceList2.add(11.29);
//        for (int i = priceList2.indexOf(34); i < priceList2.size(); i++) {
//            priceList2.add(i, 100.00);
//        }
        //System.out.println("priceList2 = " + priceList2);

        for (int i = 0; i < 5; i++) {
            priceList2.add(i, 100.0);
        }
        System.out.println("priceList2 = " + priceList2);
    }
