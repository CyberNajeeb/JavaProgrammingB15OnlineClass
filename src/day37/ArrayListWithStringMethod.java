...
public class ArrayListWithStringMethod {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < superHeroes.size(); i++) {
            String currentHeroes = superHeroes.get(i);
            if (!currentHeroes.contains("man")){
                superHeroes.remove(currentHeroes);
                //i--;

            }
        }System.out.println("super Heroes = " + superHeroes);

        System.out.println("\nvvvvvvvvv Class Code vvvvvvvvvv" + "\n");
